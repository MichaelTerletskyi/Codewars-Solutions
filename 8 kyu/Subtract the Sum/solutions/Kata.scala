object Kata {
  def subtractSum(n: Int): String = {
    var value = n
    var sum = parseSum(value)
    if (value < 100) value -= sum
    while (value > 100) {
      value -= sum
      sum = parseSum(value)
    }
    Map(1 -> "kiwi", 2 -> "pear", 3 -> "kiwi", 4 -> "banana", 5 -> "melon",
      6 -> "banana", 7 -> "melon", 8 -> "pineapple", 9 -> "apple", 10 -> "pineapple",
      11 -> "cucumber", 12 -> "pineapple", 13 -> "cucumber", 14 -> "orange", 15 -> "grape",
      16 -> "orange", 17 -> "grape", 18 -> "apple", 19 -> "grape", 20 -> "cherry", 21 -> "pear",
      ...
      57 -> "cucumber", 58 -> "orange", 59 -> "cucumber", 60 -> "orange", 61 -> "grape",
      62 -> "cherry", 63 -> "apple", 64 -> "cherry", 65 -> "pear", 66 -> "cherry", 67 -> "pear",
      68 -> "kiwi", 69 -> "pear", 70 -> "kiwi", 71 -> "banana", 72 -> "apple", 73 -> "banana",
      74 -> "melon", 75 -> "pineapple", 76 -> "melon", 77 -> "pineapple", 78 -> "cucumber", 79 -> "pineapple",
      ...
      98 -> "pineapple", 99 -> "apple", 100 -> "pineapple")(value)
  }

  def parseSum(n: Int): Int = {
    var sum: Int = 0
    val strings = n.toString.split("")
